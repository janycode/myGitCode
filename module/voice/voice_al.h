...
} jan_voice_core_status_t;

/*---------------------------------------------------------------------------*/

typedef int (*jan_voice_event_cb)(e_jan_voice_call_state_t event, void *msg_data, int msg_data_len, void *cb_param);
typedef struct jan_voice_msg_element_struct {
    jan_voice_event_cb callback;
    void *cb_param;
} jan_voice_event_element_t;

typedef struct jan_voice_event_list_node_struct {
    list_link_type *link;
    jan_voice_event_element_t event_element;
} jan_voice_event_list_node_t;

typedef struct jan_voice_call_info_struct {
    unsigned char call_id;
    e_jan_voice_call_state_t call_state;
    e_jan_voice_call_type_t call_type;
    e_jan_voice_call_direction_t call_direction;
    e_jan_voice_call_mode_t call_mode;
    char call_number[84];
} jan_voice_call_info_t;

typedef struct jan_voice_dtmf_queue_struct {
    char dtmf_num[64];
    int head;
    int tail;
} jan_voice_dtmf_queue_t;

typedef struct jan_voice_timezone_data_struct {   // add 2017.06.23
    char time_zone_name[64];
    char time_zone[64];
    char time_diff[64];
} jan_voice_timezone_data_t;

os_signal_type jan_key_signal;
os_signal_type jan_net_signal;
jan_voice_dtmf_queue_t jan_dtmf_queue;
...
*/
/*=========================================================================*/
extern unsigned char jan_voice_al_get_call_id(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_get_call_state(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_get_call_number(char *number);
...
*/
/*=========================================================================*/
extern unsigned char jan_voice_al_get_third_call_id(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_get_third_call_state(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_get_third_call_number(char *number);
...
*/
/*=========================================================================*/
extern int jan_voice_al_clear_third_call_state(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_manage_calls(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_call_answer(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_call_answer_busy(void);
...
*/
/*=========================================================================*/
extern void *jan_voice_al_digit_dtmf_thread (void *data);
...
*/
/*=========================================================================*/
extern int jan_voice_al_call_dial(char *call_number, int dial_type);
...
*/
/*=========================================================================*/
extern int jan_voice_al_call_end(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_event_register(void *callback, void *cb_param);
...
*/
/*=========================================================================*/
extern int jan_voice_al_event_unregister(void *callback);
...
*/
/*=========================================================================*/
extern int jan_voice_al_init(void);
...
*/
/*=========================================================================*/
extern int jan_voice_al_exit(void);
