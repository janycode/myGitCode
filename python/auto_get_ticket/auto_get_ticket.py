...
class Buy_Tickets(object):
    ...
    def __init__(self, username, passwd, order, passengers, dtime, starts, ends):
        ...
        self.executable_path = 'D:\Users\yuan.jiang\AppData\Local\Programs\Python\Python36\Scripts\chromedriver.exe'
    # 登录功能实现
    def login(self):
...
if __name__ == '__main__':
    ...
    dtime = '2018-02-13'
    # 出发地(需填写cookie值)
    starts = '%e6%b7%b1%e5%9c%b3' #吴堡
    # 目的地(需填写cookie值)
    ends = '%e6%b7%b1%e5%9c%b3' #西安
